...
object DestinationDetails {
  ...
  def customsOfficeOfDestination(uA: UserAnswers): CustomsOfficeOfDestinationActualType03 =
    uA.metadata.data.as[CustomsOfficeOfDestinationActualType03](customsOfficeOfDestinationActualType03.reads)

  def traderAtDestination(uA: UserAnswers): TraderAtDestinationType01 =
    uA.metadata.data.as[TraderAtDestinationType01](traderAtDestinationType01.reads)
